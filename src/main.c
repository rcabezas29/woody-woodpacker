...
#define OFFSET_TO_TEXT_SECTION_ADDR 73  // Example offset, adjust as needed
#define OFFSET_TO_TEXT_SECTION_SIZE 81  // Example offset, adjust as needed
...
int	main(int argc, char **argv)
{
	...
	memcpy(payload + OFFSET_TO_TEXT_SECTION_ADDR, &text_section->sh_addr, sizeof(text_section->sh_addr));
	...
	// encrypt_xor(file, text_section->sh_offset, text_section->sh_size, key);
